...
function TransactionsTable() {
  ...
  return (
    <div className="flex flex-col items-center font-serif justify-center w-full mt-8 sm-h-screen bg-gradient-to-b from-blue-100 to-blue-300 dark:from-gray-800 dark:to-gray-900">
      <div className="flex flex-col w-full max-w-7xl bg-white dark:bg-black shadow-lg border border-gray-200 first:rounded-lg mt-8 p-6 z-0">
        <div className="flex flex-row justify-between items-center">
          <div className="flex flex-col justify-between items-left mb-1">
            <h1 className="text-4xl font-bold text-gray-200 dark:text-gray-200">
              Investments
            </h1>
      ...
      <div className="flex flex-col w-full justify-center max-w-7xl bg-white dark:bg-black  border border-gray-200 shadow-lg rounded-lg mt-6 mb-6 p-8 z-0">
        {loading ? (
